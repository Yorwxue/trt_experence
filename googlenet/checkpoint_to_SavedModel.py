...
if __name__ == "__main__":
    ...
    batch_input_tensor = tf.placeholder(tf.float32, shape=[None, input_height, input_width, 3], name="image_batch")
    ...
    if SavedModel:
        ...
        img_tensor_info_input_bytes = tf.saved_model.utils.build_tensor_info(batch_input_tensor)
